...
ENTITY_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "ravenswood_branch": {
        ...
        "uri": GW2RES["item/ravenswood_branch"],
        "tier": 1,
    ...
    "ravenswood_staff": {
        ...
        "type": CLASS_PRECURSOR_WEAPON,
        "type_label": "PrecursorWeapon",
        "uri": GW2RES["item/ravenswood_staff"],
        "tier": 2,
        "discipline": "Artificer",
        "min_rating": 450,
    ...
    "the_raven_spirit": {
        ...
        "type": CLASS_PRECURSOR_WEAPON,
        "type_label": "PrecursorWeapon",
        "uri": GW2RES["item/the_raven_spirit"],
        "tier": 3,
        "discipline": "Artificer",
        "min_rating": 450,
    ...
    "the_living_ravens": {
        ...
        "type": CLASS_PRECURSOR_WEAPON,
        "type_label": "PrecursorWeapon",
        "uri": GW2RES["item/the_living_ravens"],
        "tier": 4,
        "discipline": "Artificer",
        "min_rating": 450,
    ...
    "gift_of_nevermore": {
        ...
        "uri": GW2RES["item/gift_of_nevermore"],
    ...
    "mystic_tribute": {
        ...
        "type": CLASS_COMPONENT_ITEM,
        "type_label": "ComponentItem",
        "uri": GW2RES["item/mystic_tribute"],
    ...
    "gift_of_mastery": {
        ...
        "type": CLASS_COMPONENT_ITEM,
        "type_label": "ComponentItem",
        "uri": GW2RES["item/gift_of_mastery"],
    ...
    "gift_of_energy": {
        ...
        "type": CLASS_COMPONENT_ITEM,
        "type_label": "ComponentItem",
        "uri": GW2RES["item/gift_of_energy"],
    ...
    "spiritwood_plank": {
        ...
        "uri": GW2RES["item/spiritwood_plank"],
    ...
    "elder_wood_plank": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/elder_wood_plank"],
    ...
    "ancient_wood_plank": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/ancient_wood_plank"],
    ...
    "deldrimor_steel_ingot": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/deldrimor_steel_ingot"],
    ...
    "elonian_leather_square": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/elonian_leather_square"],
    ...
    "bolt_of_damask": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/bolt_of_damask"],
    ...
    "amalgamated_gemstone": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/amalgamated_gemstone"],
    ...
    "bloodstone_shard": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/bloodstone_shard"],
    ...
    "crystalline_ore": {
        ...
        "type": CLASS_CRAFTING_MATERIAL,
        "type_label": "CraftingMaterial",
        "uri": GW2RES["item/crystalline_ore"],
    ...
    "grandmaster_craftsman_hobbs": {
        ...
        "type": CLASS_NPC_VENDOR,
        "type_label": "NPCVendor",
        "uri": GW2RES["vendor/grandmaster_craftsman_hobbs"],
    ...
    "riel_runecrafter": {
        ...
        "type": CLASS_NPC_VENDOR,
        "type_label": "NPCVendor",
        "uri": GW2RES["vendor/riel_runecrafter"],
    ...
    "frostgorge_sound": {
        ...
        "type": CLASS_ZONE,
        "type_label": "Zone",
        "uri": GW2RES["zone/frostgorge_sound"],
    ...
    "tangled_depths": {
        ...
        "type": CLASS_ZONE,
        "type_label": "Zone",
        "uri": GW2RES["zone/tangled_depths"],
    ...
    "artificer": {
        ...
        "uri": GW2RES["discipline/artificer"],
    ...
    "weaponsmith": {
        ...
        "type": CLASS_CRAFTING_DISCIPLINE,
        "type_label": "CraftingDiscipline",
        "uri": GW2RES["discipline/weaponsmith"],
    ...
    "huntsman": {
        ...
        "type": CLASS_CRAFTING_DISCIPLINE,
        "type_label": "CraftingDiscipline",
        "uri": GW2RES["discipline/huntsman"],
    ...
    "armorsmith": {
        ...
        "type": CLASS_CRAFTING_DISCIPLINE,
        "type_label": "CraftingDiscipline",
        "uri": GW2RES["discipline/armorsmith"],
    ...
    "leatherworker": {
        ...
        "type": CLASS_CRAFTING_DISCIPLINE,
        "type_label": "CraftingDiscipline",
        "uri": GW2RES["discipline/leatherworker"],
    ...
    "mystic_forge": {
        ...
        "type": CLASS_CRAFTING_DISCIPLINE,
        "type_label": "CraftingDiscipline",
        "uri": GW2RES["discipline/mystic_forge"],
...
def build_gw2_ontology_graph() -> Graph:
    """Constructs the base RDFLib OWL Ontology Graph for GW2-UME."""
    g = Graph()
    g.bind("gw2", GW2)
    g.bind("gw2res", GW2RES)
    g.bind("owl", OWL)
    g.bind("rdfs", RDFS)
    g.bind("rdf", RDF)
    g.bind("xsd", XSD)
    ...
    classes = [
        ...
        (CLASS_LEGENDARY_WEAPON, "Gen 2 Legendary Weapon", CLASS_ITEM),
        (CLASS_PRECURSOR_WEAPON, "Precursor Weapon Tier", CLASS_ITEM),
    ...
    # Declare Properties with Domain and Range
    properties = [
        ...
        (PROP_OBTAINED_FROM_VENDOR, "obtainedFromVendor", CLASS_ITEM, CLASS_NPC_VENDOR),
        ...
        (PROP_OUTPUT_ITEM, "outputItem", CLASS_CRAFTING_RECIPE, CLASS_ITEM),
    ...
    for p_uri, label, domain, rng in properties:
        g.add((p_uri, RDF.type, OWL.ObjectProperty if str(rng).startswith("https://") else OWL.DatatypeProperty))
